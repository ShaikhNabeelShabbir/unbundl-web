...
import { RequestNewConnectionDataTable } from "@/RequestForNewConnections/request-for-new-connections-data-table";
import {
  columns,
  RequestNewConnectionInfo,
} from "@/RequestForNewConnections/request-for-new-connections-columns";
