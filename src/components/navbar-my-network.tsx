...
const NavbarMyNetwork: React.FC<NavbarProps> = ({ setStep, currentStep }) => {
  ...
  return (
    <div>
      <div className="relative">
        <div className="flex justify-start gap-0 w-full mb-[25px] ">
          {["Expand your network", "Requests for new connections"].map(
            (label, index) => (
              <div
                key={index}
...
export default NavbarMyNetwork;
