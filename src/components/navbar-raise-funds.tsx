...
const NavbarRaiseFunds: React.FC<NavbarProps> = ({ setStep, currentStep }) => {
    ...
    <div>
      <div className="relative">
        <div
         ...
         gap-0 px-14 md:px-5 w-full"
        >
          {["Reach out to investors", "Requests from investors"].map(
            (label, index) => (
              <div
                key={index}
...
export default NavbarRaiseFunds;
